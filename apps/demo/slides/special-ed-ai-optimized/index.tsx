...
import imgPracticeLinks from '@assets/practice-links.webp';
...
const PartHeaderPage = ({
  ...
  <div style={{ ...fill, justifyContent: 'center', alignItems: 'center' }}>
    ...
    >
      ...
      >
        {['需求', '行政', '簡化', '網頁', '發佈', '總結'].map((item, idx) => {
          const partIndex = idx + 1;
          const currentPart = Number.parseInt(partNum, 10);
          const isActive = partIndex === currentPart;
          const isPassed = partIndex < currentPart;
          return (
            <div
              key={item}
              style={{
                ...
                alignItems: 'center',
                gap: 6,
                opacity: isActive ? 1 : isPassed ? 0.75 : 0.4,
            ...
            >
              <div
                style={{
                  ...
                  height: '32px',
                  borderRadius: '50%',
                  background: isActive ? colors.orange : isPassed ? colors.accent : '#cbd5e1',
                  color: '#fff',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
              ...
              <span>{item}</span>
              {idx < 5 && (
                <span style={{ color: '#cbd5e1', marginLeft: 10, fontWeight: 300 }}>➔</span>
              )}
            </div>
          );
        })}
...
// Slide 25: 解決對策：網頁教材配圖的三種 AI 解決方案
const Slide25_ImageSolutions: Page = () => (
  <div style={fill}>
    <TextbookBg />
    <TextbookHeader
      title="網頁教材配圖的 3 種 AI 解決方案"
      subtitle="擺退全是表情符號 (Emoji) 的困境"
      unit="單元 4"
    />
    <div
      style={{
    ...
    >
      <Panel delay={0.1} style={{ padding: '24px 28px', gap: 12 }}>
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 16 }}>
          ...
          <p style={{ margin: 0, fontSize: '28px', lineHeight: 1.36, color: colors.muted }}>
            到 Unsplash 找圖，對圖片按右鍵，複製圖片網址後貼給 AI。
          </p>
          <div
            style={{
              background: '#f1f5f9',
          ...
          >
            咒語：請把這個圖片網址放進網頁中，作為「主題」配圖：
            <br />
            <span style={{ color: colors.accent, overflowWrap: 'anywhere' }}>[貼上圖片網址]</span>
          </div>
        </div>
      </Panel>
      <Panel delay={0.2} accent={colors.orange} style={{ padding: '24px 28px', gap: 12 }}>
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 16 }}>
          <div>
            <div
              style={{
          ...
          >
            咒語：請完全使用內嵌 SVG 畫一張「主題」插圖，風格簡單清楚，不要使用
            Emoji，不要使用外部圖片。
          </div>
          <p style={{ margin: 0, fontSize: '27px', lineHeight: 1.36, color: colors.muted }}>
            適合按鈕圖示、概念小插圖、乾淨背景。
          </p>
        </div>
      </Panel>
      <Panel delay={0.3} style={{ padding: '24px 28px', gap: 12 }}>
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 16 }}>
          <div>
            <div
              style={{
          ...
          <p style={{ margin: 0, fontSize: '27px', lineHeight: 1.36, color: colors.muted }}>
            圖片按右鍵「共用」，一般存取改成「知道連結的任何人」，角色維持「檢視者」。
          </p>
          <div
            style={{
              background: '#ecfeff',
          ...
          >
            咒語：請把這個 Google Drive 圖片連結放進網頁中：
            <br />
            <span style={{ color: colors.accent, overflowWrap: 'anywhere' }}>[貼上共用連結]</span>
          </div>
        </div>
      </Panel>
    </div>
...
const Slide31b_GithubPages: Page = () => (
  <div style={{ ...fill, padding: '88px 120px 132px 120px' }}>
    <TextbookBg />
    <TextbookHeader
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, flex: 1, zIndex: 2 }}>
      <Panel
        title="第一階段：上傳檔案"
        delay={0.1}
        style={{ padding: '20px 28px', gap: 8, lineHeight: 1.35 }}
      >
        <ul
          style={{
            paddingLeft: '20px',
    ...
    >
      ...
      <div>
        <strong>部署常見卡關檢核</strong>：1. 檔案名稱必須是小寫的 <code>index.html</code>{' '}
        (不可有大寫)。 2. 專案庫權限必須設為 <code>Public (公開)</code>，設為 Private 無法免費發佈。
        3. 修改後需等待約 1-2 分鐘重整才會生效。
      </div>
    </div>
    <TextbookFooter subtitle="第五部分：發佈與共享篇" />
  </div>
...
// Slide 34b: 未來展望：從單一工具到自主 AI Agent
const Slide34_AgentOutlook: Page = () => (
  <div style={fill}>
    <TextbookBg />
    <TextbookHeader
      title="未來展望：從單一工具到自主 AI Agent"
      subtitle="備課大腦的演進"
      unit="單元 6"
    />
    <div
    ...
    >
      ...
      >
        ...
        >
          <li>
            <strong>儲存常用設定</strong>：儲存角色設定與提示詞，省去重複輸入。
          </li>
          <li>
            <strong>手動串接工作</strong>
            ：老師需要手動將簡化完的文字，複製到下一個「字卡生成網頁」或「語音生成器」中。
          </li>
        </ul>
        <div style={{ marginTop: 'auto', fontSize: '26px', color: '#7c3aed', fontStyle: 'italic' }}>
          例：「教材簡化 Gem」➔ 手動複製 ➔「語音報讀 Gem」➔ 一步步手動處理
        </div>
      </Panel>
      {/* Right: Agent */}
      <Panel
        title="🤖 2.0 智能時代：自主代理 (AI Agent)"
        delay={0.2}
        accent={colors.orange}
        style={{ display: 'flex', flexDirection: 'column', gap: 14 }}
      >
        ...
        >
          <li>
            <strong>工作流自動化</strong>：AI
            不僅能理解指令，還能自主規劃「第一步做簡化、第二步加注音、第三步做成 HTML 語音報讀檔」。
          </li>
          <li>
            <strong>一鍵生成大包裝</strong>：省去中間複製貼上的繁瑣步驟，實現點狀工作自動串聯。
          </li>
        </ul>
        <div
          style={{ marginTop: 'auto', fontSize: '26px', color: colors.orange, fontStyle: 'italic' }}
        >
          例：輸入「小明需要段考句型練習」➔ AI Agent 自動分析、簡化、產生點讀
          HTML，並自動上傳至雲端分享。
        </div>
      </Panel>
    </div>
...
// Slide 21 (Practice Choice): 網頁互動教材三選一實作任務
const Slide21_PracticeChoice: Page = () => (
  <div style={{ ...fill, padding: '88px 105px 132px 105px' }}>
    <TextbookBg />
    <TextbookHeader
      title="實作 3︰網頁互動教材三選一實作（20分鐘）"
      subtitle="自主實作"
      unit="單元 4"
    />
    <div
    ...
    >
      ...
      >
        請挑選一個您最感興趣或最切合教學需求的情境進行自製與改編：
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 18, minHeight: 0 }}>
        <Panel
          title="📝 1. 互動句型排列"
          delay={0.1}
          style={{ padding: '18px 22px', gap: 8, lineHeight: 1.35 }}
        >
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 10 }}>
            <p style={{ margin: 0, fontSize: '25px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>適用</strong>：國文語序重組、英文句型排列、故事因果重組。
            </p>
            <p style={{ margin: 0, fontSize: '24px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>體驗重點</strong>：卡片拖曳與點選、TTS 語音反饋朗讀、成功答題後的視覺回饋。
            </p>
          </div>
        </Panel>
        <Panel
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 10 }}>
            <p style={{ margin: 0, fontSize: '25px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>適用</strong>：詞彙填充、成語配對、圖文語意對照。
            </p>
            <p style={{ margin: 0, fontSize: '24px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>體驗重點</strong>
              ：抗衝動設計（確認按鈕分離）、答錯時的二次提示機制與輔助圖片。
            </p>
          </div>
        </Panel>
        <Panel
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 10 }}>
            <p style={{ margin: 0, fontSize: '25px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>適用</strong>：長文閱讀理解、段落式問答、分段式精讀。
            </p>
            <p style={{ margin: 0, fontSize: '24px', color: colors.muted, lineHeight: 1.32 }}>
              <strong>體驗重點</strong>：段落式高亮同步、語速調整與重複報讀、控制答題的倒數計時。
            </p>
          </div>
        </Panel>
      </div>
      ...
      >
        <div style={{ fontSize: '24px', lineHeight: 1.3, fontWeight: 700 }}>
          💡 <strong>改編技巧</strong>：點擊 Padlet 上的「試用 Gemini
          Canvas」以複製模板，接著貼上您的課文內容，下指令：
          <span style={{ color: colors.orange, fontWeight: 900 }}>
            「請幫我將原本的題目換成上述的課文與填充題」
          </span>
          即可！
        </div>
        <UploadEntryLink delay={0.4} compact />
      </div>
    </div>
    <TextbookFooter subtitle="第四部分：網頁教材實戰" />
  </div>
...
export default [
  ...
  Slide22_WebTool2,
  Slide24_WebTool3,
  Slide21_PracticeChoice,
  Slide24b_InteractiveTemplates,
  Slide25_ImageSolutions,
  Slide29_Workshop2,
  Slide30_Part4Header,
  Slide31_PortalPain,
